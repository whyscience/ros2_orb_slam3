...
def generate_launch_description():
    ...
    voc_file = Path(get_package_share_directory('ros2_orb_slam3'), 'orb_slam3', 'Vocabulary', 'ORBvoc.txt.bin')
    ...
    orb_mono = Node(
        ...
        output='screen',
        parameters=[{
            'voc_file': voc_file.as_posix(),
            'settings_file_path': settings_file_path.as_posix(),
