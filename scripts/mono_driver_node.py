...
class MonoDriver(Node):
    def __init__(self, node_name="mono_py_node"):
        ...
        self.home_dir = str(
            Path.home()) + "/ros2_test/src/ros2_orb_slam3"  # ! Change this to match path to your workspace
        ...
        self.publish_exp_config_ = self.create_publisher(String, self.pub_exp_config_name,
                                                         1)  # Publish configs to the ORB-SLAM3 C++ node
    ...
    def run_py_node(self, idx, imgz_name):
        ...
        timestep = float(
            imgz_name.split(".")[0])  # Kept if you use a custom message interface to also pass timestep value
...
def main(args=None):
    ...
    rate = n.create_rate(
        20)  # https://answers.ros.org/question/358343/rate-and-sleep-function-in-rclpy-library-for-ros2/
